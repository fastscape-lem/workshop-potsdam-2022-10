...
[![Test notebooks](https://github.com/fastscape-lem/workshop-potsdam-2022-10/workflows/Test%20notebooks/badge.svg)](https://github.com/fastscape-lem/workshop-potsdam-2022-10/actions)

# Workshop on Xarray / Xarray-simlab (Potsdam, 10-2022)
...
```bash
$ docker pull fastscape/workshop-potsdam-2022-10:latest
```
...
$ docker run \
    ...
    fastscape/workshop-potsdam-2022-10 \
...
```bash
$ git clone https://github.com/fastscape-lem/workshop-potsdam-2022-10
$ cd workshop-potsdam-2022-10
$ conda env create -f environment.yml
$ conda activate workshop-potsdam-2022-10
```
...
```bash
$ conda env update -n workshop-potsdam-2022-10 --file environment-dev.yml 
```
